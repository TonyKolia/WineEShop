...
<html lang="en">
  ...
  <!-- User screen where the user's pending orders (completed, cancelled) are displayed 
      ...
      <h3 class='purple-label order-management-label'><i class='fas fa-file-alt'></i>Οι παραγγελίες μου</h3>
        ...
        <table class="table table-hover basket-table">
            ...
            <?php
                ...
                //get all the pending orders for the users
                $sql = "select a.id as id, b.description as order_status from orders a join order_statuses b on a.order_status = b.id where order_status not in (4,5) and user_id = $userId";
            ...
            <div class='basket-buttons'>
                <a href='./user_completed_orders.php' class='btn btn-primary btn-purple'><i class='fas fa-check-circle'></i>ΟΛΟΚΛΗΡΩΜΕΝΕΣ</a>
            </div>
